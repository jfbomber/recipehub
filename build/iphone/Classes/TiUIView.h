...
/**
 Base class for all recipehub views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the recipehub view hierarchy (such as wrapped iOS UIViews) was touched.
