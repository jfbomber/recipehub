...
// in simulator we redefine to format for recipehub Developer console
...
{\
	NSString * exceptionName = [@"org.recipehub." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.recipehub";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIrecipehubNativeItemNone = -1, 
	UIrecipehubNativeItemSpinner = -2,
	UIrecipehubNativeItemProgressBar = -3,
	
	UIrecipehubNativeItemSlider = -4,
	UIrecipehubNativeItemSwitch = -5,
	UIrecipehubNativeItemMultiButton = -6,
	UIrecipehubNativeItemSegmented = -7,
	
	UIrecipehubNativeItemTextView = -8,
	UIrecipehubNativeItemTextField = -9,
	UIrecipehubNativeItemSearchBar = -10,
	
	UIrecipehubNativeItemPicker = -11,
	UIrecipehubNativeItemDatePicker = -12,
	
	UIrecipehubNativeItemInfoLight = -13,
	UIrecipehubNativeItemInfoDark = -14,
	
	UIrecipehubNativeItemDisclosure = -15,
	
	UIrecipehubNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all recipehub instances of
