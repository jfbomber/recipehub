...
@interface recipehubObject : KrollCoverageObject {
#else
@interface recipehubObject : KrollObject {
#endif
@private
...
extern NSString * recipehub$ModuleRequireFormat;
