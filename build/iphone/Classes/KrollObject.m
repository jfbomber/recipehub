...
//@interface recipehubObject : NSObject
//@end

@interface recipehubObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[recipehubObject class]])
		{
			for (NSString *key in [[(recipehubObject*)o modules] allKeys])
			{
